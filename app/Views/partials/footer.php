    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col footer-col--brand">
                <a href="<?= baseUrl() ?>" class="footer-logo-link">
                    <?php $footerLogo = setting('site_logo'); ?>
                    <?php if ($footerLogo): ?>
                        <img src="<?= e(baseUrl($footerLogo)) ?>" alt="SOLYRA" class="footer-logo-img">
                    <?php endif; ?>
                    <span class="footer-brand">SOLYRA</span>
                </a>
                <p class="footer-desc">
                    <?= e(pageContent('footer', 'brand', 'description', 'Luminárias, decoração e peças exclusivas impressas em 3D com tecnologia de ponta.')) ?>
                </p>
                <div class="footer-social">
                    <?php if ($ig = setting('social_instagram')): ?>
                        <a href="<?= e($ig) ?>" target="_blank" rel="noopener" class="social-link" aria-label="Instagram">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <li><a href="<?= baseUrl('catalogo') ?>">Catálogo</a></li>
                    <li><a href="<?= baseUrl('pronta-entrega') ?>">Pronta Entrega</a></li>
                ...
                <ul class="footer-contact">
                    <?php if ($whatsapp = setting('site_whatsapp')): ?>
                        <li>
                            ...
                            <a href="<?= whatsappLink($whatsapp, 'Olá! Gostaria de entrar em contato com a SOLYRA.') ?>" target="_blank"><?= e($whatsapp) ?></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <li>
                        ...
                        <span><?= setting('site_address', 'Monte Verde - Florianópolis/SC') ?></span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> SOLYRA. Todos os direitos reservados.</p>
        </div>
    </div>
</footer>
